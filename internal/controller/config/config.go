...
import (
	...
	"github.com/stuttgart-things/provider-kubeconfig/apis/v1alpha1"
)
...
func setupNamespacedProviderConfig(mgr ctrl.Manager, o controller.Options) error {
	...
	r := providerconfig.NewReconciler(mgr, of,
		...
		providerconfig.WithRecorder(event.NewAPIRecorder(mgr.GetEventRecorderFor(name)))) //nolint:staticcheck // crossplane runtime requires old event API
