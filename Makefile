# ====================================================================================
# Setup Project
PROJECT_NAME := provider-kubeconfig
...
XPKGS = provider-kubeconfig
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-kubeconfig: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Kubeconfig CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Kubeconfig controllers
...
# This target prepares repo for your provider by replacing all "kubeconfig"
